          ...
          <li v-if="props.user">
            ...
            <Teleport to="body">
              ...
              <Transition name="fade" enter-active-class=" duration-500 ease-out" enter-from-class=" opacity-0 scale-95" leave-active-class="duration-300 ease-out" leave-from-class="opacity-100" leave-to-class="opacity-0 scale-80">
                <div v-if="isDelModalOpen === true"  class="fixed z-999 bg-white flex items-center justify-center font-poppins rounded-md text-black drop-shadow-xl drop-shadow-black/30 lg:inset-x-100 lg:inset-y-100 lg:top-40 lg:bottom-40">
